<template>
    <div class="content-block">
        ...
        <section style="margin: 20px 0;">
            <div class="dsxui-form-inline">
                <div class="form-item">
                    ...
                    <el-input size="small" class="w200" clearable v-model="searchFields.order_no"/>
                </div>
                <div class="form-item">
                    <div class="form-item-label">商品名称</div>
                    <el-input size="small" class="w200" clearable v-model="searchFields.product"/>
                </div>
                <div class="form-item">
        ...
        <section>
            ...
            <div class="order-list">
                <table class="order-table">
                    ...
                    <tr>
                        <th>宝贝</th>
                        <th width="100" class="align-center">单价</th>
                        <th width="70" class="align-center">数量</th>
                        <th width="120" class="align-center">实付款</th>
                        <th width="110" class="align-center">交易状态</th>
                        <th width="105" class="align-center">交易操作</th>
                    </tr>
                    </thead>
                </table>
                                ...
                                <tr v-for="(item,idx) in order.items">
                                    ...
                                    <td>
                                        <div class="align-center" v-if="idx===0">
                                            <p><strong class="font-14">￥{{ order.total }}</strong></p>
                                    ...
                                    <td>
                                        <div class="align-center" v-if="idx===0">
                                            ...
                                            <router-link :to="'/orders/'+order.order_id">订单详情
                                            </router-link>
                                        </div>
                                    </td>
                                    <td>
        ...
        <el-dialog title="取消订单" width="450px"
...
export default {
    ...
    mounted() {
        this.fetchList();
        ApiService.get('/shortcuts?type=close_reason').then(response => {
