<template>
    <div class="container" style="padding-bottom: 50px;">
        <div class="cart" style="background-color: #fff;" v-if="dataList.length>0">
            <van-checkbox-group v-model="result" @change="handleChange" ref="checkboxGroup">
                <van-swipe-cell :right-width="65" v-for="(item,index) in dataList" :key="index">
                    <div class="cart-item">
