...
export default {
    ...
    methods: {
        fetchData() {
            ...
            if (!id) return;
            ApiService.get('/freight-templates/' + id).then(response => {
        ...
        onSubmit() {
            ...
            let {id} = this.$route.params;
            if (id) {
                ApiService.put('/freight-templates/' + id, {template}).then(() => {
                ...
                ApiService.post('/freight-templates', {template}).then(response => {
                    ...
                    this.$router.replace('/freight-template/edit/' + response.data.id);
                });
            }
        }
    },
