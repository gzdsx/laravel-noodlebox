        ...
        <el-dialog title="编辑信息" closeable :visible.sync="showDialog" :close-on-click-modal="false"
            ...
            <el-form label-width="80px">
                <el-form-item label="快递名称">
                    <el-input size="medium" v-model="express.name"/>
                </el-form-item>
                <el-form-item label="公司代码">
                    <el-input size="medium" v-model="express.code"/>
                </el-form-item>
                <el-form-item label="单号规则">
                    <el-input size="medium" v-model="express.regular"/>
                    <div class="el-form-tips">单号正则表达式</div>
                </el-form-item>
                <el-form-item>
    ...
    methods: {
        ...
        onDelete() {
            ...
            this.$confirm('此操作将永久删除所选信息, 是否继续?', '提示', {
                ...
                ApiService.delete('/expresses/batch', {data:{ids}}).then(() => {
                    this.fetchList();
                });
            });
        },
        onSubmit() {
            ...
            if (express.id) {
                ApiService.put('/expresses/' + express.id, {express}).then(() => {
                ...
                ApiService.post('/expresses', {express}).then(() => {
                    this.showDialog = false;
