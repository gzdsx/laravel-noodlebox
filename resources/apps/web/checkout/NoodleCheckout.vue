        ...
        <div class="checkout-body">
            ...
            <div class="checkout-col checkout-order">
                ...
                <div class="order-items">
                    ...
                    <div class="order-item" v-for="(item,index) in cart_items" :key="index">
                        <div class="order-item__product">
                            ...
                            <div class="additional">Points: 9</div>
                ...
                <div class="form-group mt-5">
                    <button class="btn btn-block btn-bull-cyan btn-lg text-white" @click="submitOrder">Place Order
                    </button>
                </div>
    ...
    methods: {
        ...
        submitOrder() {
            ...
            if (shipping_method === 'delivery') {
                let method = this.shipping_zones[this.shipping_zone_index];
                fee_lines.push({
                    name: 'Shipping Fee',
                    total: method.fee,
                    total_tax: 0
