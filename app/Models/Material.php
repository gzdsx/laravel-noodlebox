 ...
 * @method static Builder|Material whereSrc($value)
...
class Material extends Model
{
    ...
    protected $fillable = [
        'id', 'user_id', 'name', 'description', 'src', 'thumb', 'width', 'height', 'type', 'extension', 'size', 'views', 'downloads', 'mime'
    ];
    ...
    public static function boot()
    {
        ...
        static::creating(function (Material $material) {
            if (!$material->user_id) {
                $material->user_id = Auth::id() ?: 0;
            }
        });

        static::deleting(function (Material $material) {
            Storage::disk()->delete($material->getRawOriginal('src'));
    ...
    {
        $this->attributes['src'] = strip_image_url($value);
    }
