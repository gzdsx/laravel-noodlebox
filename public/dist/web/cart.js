...
var _NoodleLogin = _interopRequireDefault(__webpack_require__(/*! ../components/NoodleLogin.vue */ "./resources/apps/web/components/NoodleLogin.vue"));
...
var _default = exports["default"] = {
  ...
  methods: {
    ...
    onQuantityChange: function onQuantityChange(index) {
      var _this$cart_items$inde = this.cart_items[index],
        id = _this$cart_items$inde.id,
        quantity = _this$cart_items$inde.quantity;
      //this.loading = true;
      _HttpClient["default"].put('/carts/' + id, {
        quantity: quantity
      })["finally"](function () {
        //this.loading = false;
      });
    ...
    fetchCartItems: function fetchCartItems() {
      ...
      _HttpClient["default"].get('/carts').then(function (res) {
        ...
        _this2.cart_items = res.data.items;
...
var render = exports.render = function render() {
  var _vm = this,
    _c = _vm._self._c;
  return _vm.loading ? _c("noodle-loading") : _c("div", {
